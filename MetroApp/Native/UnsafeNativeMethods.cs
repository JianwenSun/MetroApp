...
namespace MetroApp.Native
{
    ...
    internal static class UnsafeNativeMethods
    {
        ...
        internal static extern int DwmExtendFrameIntoClientArea(IntPtr hWnd, [In] ref _Margin pMarInset);
        ...
        [return: MarshalAs(UnmanagedType.Bool)]
        internal static extern bool GetMonitorInfo([In] IntPtr hMonitor, [Out] _MonitorInfo lpmi);
        ...
        internal static extern IntPtr MonitorFromPoint(_Point pt, _MonitorInfo.MonitorOptions dwFlags);
        ...
        [DllImport("user32")]
        internal static extern bool GetCursorPos([Out] out _Point pt);
        ...
        internal static _Point GetPoint(IntPtr ptr)
        {
        ...
        public static extern int SHAppBarMessage(int dwMessage, ref _AppBarData pData);
