...
namespace MetroApp.Behaviours
{
    ...
    public class BorderlessWindowBehavior : Behavior<Window>
    {
        ...
        private System.IntPtr WindowProc(System.IntPtr hwnd, int msg, System.IntPtr wParam, System.IntPtr lParam, ref bool handled)
        {
            ...
            switch (msg) {
                case Constants.WM_NCPAINT:
                    var borderShadow = BorderShadow;
                    var metroWindow = AssociatedObject as MetroWindow;
                    if (metroWindow != null)
                    {
                        borderShadow = metroWindow.GlowBrush == null && (metroWindow.BorderShadow || BorderShadow);
                    }
                    if (borderShadow)
                    {
                        var val = 2;
                        UnsafeNativeMethods.DwmSetWindowAttribute(hwnd, 2, ref val, 4);
                        var m = new _Margin { bottomHeight = 1, leftWidth = 1, rightWidth = 1, topHeight = 1 };
        ...
        public static readonly DependencyProperty BorderShadowProperty = DependencyProperty.Register("BorderShadow", typeof(bool), typeof(BorderlessWindowBehavior), new PropertyMetadata(false));
